...
//
// El panel superior separa cobertura, controles estructurales, frescura y
// conciliación. La lógica de parseo, mapeo, validación y reporte queda intacta.
...
import { DatosConfiabilidad } from "@/components/commercial/DatosConfiabilidad";
...
const SECCIONES = [
  { id: "sec-confiabilidad", etiqueta: "Confiabilidad" },
  { id: "sec-pareto", etiqueta: "Pareto" },
  { id: "sec-conciliacion", etiqueta: "Conciliación" },
  { id: "sec-carga", etiqueta: "Cargar y mapear" },
  { id: "sec-reporte", etiqueta: "Reporte de calidad" },
];

export default function PaginaDatos() {
  const { dataset, cargando, errorDatosReales, reemplazarDataset, volverADemo, fmt } = useApp();
