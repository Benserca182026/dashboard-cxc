...
export default function PaginaCategoriasProducto() {
  ...
  const lateral = <p>La lectura usa líneas a precio de lista. No se presenta como venta neta ni margen porque el descuento no está en la línea.</p>;
  ...
  return <div className="space-y-5"><Encabezado titulo="Categorías de producto" secciones={SECCIONES} dataset={dataset} modulo="ventas" /><div id="sec-productos" className="scroll-mt-24"><PanelAgentesReferencia agentes={agentes} activo={activo} onSeleccionar={setActivo} handoff={lateral}>{centro}</PanelAgentesReferencia></div></div>;
}
