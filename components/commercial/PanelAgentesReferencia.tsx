  ...
  return (
    <section className="bg-white py-2 md:py-3">
      <div className="relative mx-auto flex min-h-[540px] max-w-5xl gap-5 overflow-visible">
        <aside className={`z-20 w-[118px] shrink-0 rounded-[30px] border border-[#edf1fb] bg-[linear-gradient(180deg,#fbfcff_0%,#f6f8ff_100%)] px-3 py-5 shadow-[0_20px_48px_rgba(71,105,175,.1)] transition duration-500 md:w-[150px] md:px-4 ${detalleAbierto ? "pointer-events-none opacity-25 blur-[3px]" : ""}`}>
        ...
        <div className="relative min-w-0 flex-1 overflow-hidden rounded-[30px] border border-[#edf1fb] bg-white shadow-[0_24px_58px_rgba(71,105,175,.1)]">
          ...
          <main className="relative min-h-[540px] overflow-hidden px-5 py-8 md:px-10">
        ...
        {!detalleAbierto && <div className="absolute left-[calc(118px+18px)] top-5 z-40 w-[210px] rounded-2xl border border-white bg-white/95 p-3 shadow-[0_16px_34px_rgba(71,103,171,.18)] md:left-[calc(150px+20px)]">
