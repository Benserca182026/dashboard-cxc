...
const ITEMS = [
  ...
  { href: "/crm", etiqueta: "CRM comercial", icono: "⌁", grupo: "Operación" },
  { href: "/ordenes-compra", etiqueta: "Órdenes de compra", icono: "□", grupo: "Operación" },
  { href: "/comisiones", etiqueta: "Comisiones", icono: "◉", grupo: "Operación" },
  { href: "/ventas/metas", etiqueta: "Metas comerciales", icono: "◎", grupo: "Operación" },
